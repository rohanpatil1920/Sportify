              ...
              <div className="g-0 lg:flex lg:flex-wrap">
                ...
                <div className="px-4 md:px-0 lg:w-6/12">
                  <div className="md:mx-6 md:p-12">
                    <h3 className="mb-4 text-2xl font-bold text-center text-gray-800 dark:text-grey-800">
                      SignUp</h3>
                    <div className="bg-white border-gray-800">
                      <form>
                        ...
                        <div className="mb-12 pb-1 pt-1 text-center w-40">
                          <Link
                            to="/post-register"
                            className="mt-5 inline-block w-full rounded px-6 pb-2 pt-2.5 text-xs font-bold uppercase leading-normal text-white shadow-[0_4px_9px_-4px_rgba(0,0,0,0.2)] transition duration-150 ease-in-out hover:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:outline-none focus:ring-0 active:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)]"
                            type="button"
                            style={{
                              background:
                                "linear-gradient(130deg, rgba(11,185,1,1) 0%, rgba(41,121,9,1) 45%, rgba(2,102,6,1) 100%)",
                        ...
                        <div className="flex items-start justify-start pb-6">
                          <p className="mb-0 mx-2  text-black">
                          ...
                          <TERipple rippleColor="light">
                            <Link
                              to="/login"
                              type="button"
                              className="inline-block outline-none rounded px-6 pb-2 pt-1 text-xs font-bold uppercase leading-normal text-green-900 transition duration-500 ease-in-out hover:bg-lime-700 hover:outline-none hover:text-primary focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 dark:hover:bg-neutral-950 dark:hover:bg-opacity-100"
                            >
                              Login
                            </Link>
                          </TERipple>
