...
//               <div
//                 key={venue.id}
//                 className="mx-4 w-64 bg-white rounded-lg shadow-lg overflow-hidden transform transition-all hover:scale-105 hover:shadow-xl"
//               >
//                 <img
//                   src={dummyImages[index % dummyImages.length]} // Assign an image using the modulus operator
//                   alt={venue.name}
...
//                     {venue.name}
//                   </h3>
//                   <p className="text-gray-600">{venue.locality}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
