...
const Navbar: React.FC = () => {
  ...
  const forceRefresh = () => {
    ...
    setIsLoggedIn(!!userId); // Update the logged-in state immediately
  };
          ...
          <div className="hidden md:flex space-x-4 items-center">
            ...
            {isLoggedIn ? (
              <span
                ...
                className="relative overflow-hidden text-white hover:bg-green-900 hover:text-neutral-50 px-3 py-2 rounded-md text-md font-medium transition duration-300 ease-in-out cursor-pointer"
              >
                Sign Out
              </span>
            ) : (
              <>
                <Link
                  ...
                  className="relative overflow-hidden text-white hover:bg-green-900 hover:text-neutral-50 px-3 py-2 rounded-md text-md font-medium transition duration-300 ease-in-out"
                  onMouseDown={createRipple}
                  onClick={forceRefresh} // Force refresh after login
                >
                  Login/Signup
                </Link>
                <Link
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          {isLoggedIn ? (
            <span
              ...
              className="block w-full text-left text-white hover:bg-green-900 px-3 py-2 rounded-md text-base font-medium transition duration-300 ease-in-out cursor-pointer"
            >
              Sign Out
            </span>
          ) : (
